...
# Dynamically compute path relative to this script
base_dir = os.path.dirname(os.path.abspath(__file__))
signal_data = os.path.join(base_dir, "..", "Scripts", "SDR", "Data", "signal.csv")

df = pd.read_csv(signal_data).head(5000).rename(columns={'TX Magnitude': 'Noisy Signal', 'RX Magnitude': 'Clean Signal'})

if len(df) < 10:
   exit()

# Load trained SAC model
model_path = os.path.join(base_dir, "..","models", "sac_noise_reduction_051325_2pm")
